...
class TransactionsAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (holder) {
            is SummaryViewHolder -> holder.bind((items[position] as AccountSummaryItem).summary)
            is DateViewHolder -> holder.bind((items[position] as DateItem).date)
            is TransactionViewHolder -> holder.bind((items[position] as TransactionItem).transaction)
        }
    }
    ...
    class SummaryViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(summary: AccountSummary) = with(itemView) {
